...
public class TransactionalConfig {
    ...
    private static final String[] DEFAULT_REQUIRED_METHOD_RULE_TRANSACTION_ATTRIBUTES = {"add*", "save*", "insert*",
        ...
        "modify*", "execute*", "merge*", "put*", "sync*", "copy*", "change*", "adjust*", "start*", "init*", "upload*",
        "batch*", "has*", "publish*", "import*", "export*", "disable*", "cancel*", "submit*", "send*", "process*",
        "complete*", "hide*", "top*", "reset*", "bind*", "handle*", "reSubmit*", "close*", "register*", "sign*"};
    /**
     * 默认的只读事务
     */
     ...
     *            : 事务管理器
     */
    @Bean(name = CUSTOMIZE_TRANSACTION_INTERCEPTOR_NAME)
